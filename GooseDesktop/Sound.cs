...
namespace GooseDesktop
{
	...
	internal static class Sound
	{
		...
		// Token: 0x06000044 RID: 68 RVA: 0x00002EA4 File Offset: 0x000010A4
		...
		// Token: 0x06000045 RID: 69 RVA: 0x00002F04 File Offset: 0x00001104
		...
		// Token: 0x06000046 RID: 70 RVA: 0x00002F42 File Offset: 0x00001142
		...
		{
			// Token: 0x0600007D RID: 125 RVA: 0x000050E3 File Offset: 0x000032E3
			...
			// Token: 0x0600007F RID: 127 RVA: 0x00005152 File Offset: 0x00003352
			public void Pause()
			{
				Sound.Mp3Player.mciSendString(string.Format("stop {0}", this.alias), null, 0, IntPtr.Zero);
			}

			// Token: 0x06000080 RID: 128 RVA: 0x00005174 File Offset: 0x00003374
			...
			// Token: 0x06000081 RID: 129 RVA: 0x000051C1 File Offset: 0x000033C1
			public void Dispose()
			{
				Sound.Mp3Player.mciSendString(string.Format("close {0}", this.alias), null, 0, IntPtr.Zero);
			}

			// Token: 0x06000082 RID: 130 RVA: 0x000051E0 File Offset: 0x000033E0
			...
			// Token: 0x06000083 RID: 131 RVA: 0x00005200 File Offset: 0x00003400
			public void Restart()
			{
