...
namespace GooseDesktop
{
	...
	{
		// Token: 0x06000048 RID: 72 RVA: 0x00002FD8 File Offset: 0x000011D8
		...
		// Token: 0x0600004E RID: 78 RVA: 0x000037AC File Offset: 0x000019AC
		...
		// Token: 0x0600004F RID: 79 RVA: 0x00003AE9 File Offset: 0x00001CE9
		private static void CollectMemeTask_CancelEarly(object sender, FormClosingEventArgs args)
		{
			TheGoose.SetTask(TheGoose.GooseTask.NabMouse);
		}

		// Token: 0x06000050 RID: 80 RVA: 0x00003AF4 File Offset: 0x00001CF4
		...
		private static void ChooseNextTask()
		{
			...
			float num = 8f;
			if (Time.time > num * 60f && !TheGoose.hasAskedForDonation)
			{
		...
		// Token: 0x06000052 RID: 82 RVA: 0x00003D69 File Offset: 0x00001F69
		...
		// Token: 0x06000054 RID: 84 RVA: 0x00003F38 File Offset: 0x00002138
		...
		// Token: 0x06000055 RID: 85 RVA: 0x00003F88 File Offset: 0x00002188
		...
		// Token: 0x06000056 RID: 86 RVA: 0x00004078 File Offset: 0x00002278
		...
		// Token: 0x06000057 RID: 87 RVA: 0x00004278 File Offset: 0x00002478
		...
		// Token: 0x06000059 RID: 89 RVA: 0x00004318 File Offset: 0x00002518
		public static void UpdateRig()
		{
			...
			Vector2 fromAngleDegrees = Vector2.GetFromAngleDegrees(num) * b;
		...
		public static void Render(Graphics g)
		{
			...
			TheGoose.UpdateRig();
			float num8 = TheGoose.direction;
			int num3 = (int)TheGoose.position.x;
			int num4 = (int)TheGoose.position.y;
			Vector2 vector = new Vector2((float)num3, (float)num4);
			Vector2 b = new Vector2(1.3f, 0.4f);
			Vector2 fromAngleDegrees = Vector2.GetFromAngleDegrees(num8) * b;
			Vector2 fromAngleDegrees2 = Vector2.GetFromAngleDegrees(num8 + 90f) * b;
			...
			TheGoose.DrawingPen.Width = (float)(22 + num5);
			...
			TheGoose.DrawingPen.Width = (float)(13 + num5);
			...
			TheGoose.DrawingPen.Width = (float)(15 + num5);
			...
			TheGoose.DrawingPen.Width = (float)(10 + num5);
			...
			int num6 = 9;
			int num7 = 3;
			TheGoose.DrawingPen.Width = (float)num6;
			TheGoose.DrawingPen.Brush = Brushes.Orange;
			Vector2 vector2 = TheGoose.gooseRig.head2EndPoint + fromAngleDegrees * (float)num7;
		...
		// Token: 0x0600005B RID: 91 RVA: 0x000049DF File Offset: 0x00002BDF
		...
		// Token: 0x0600005D RID: 93 RVA: 0x00004A07 File Offset: 0x00002C07
		...
		// Token: 0x0600005E RID: 94 RVA: 0x00004A20 File Offset: 0x00002C20
		...
		// Token: 0x0600005F RID: 95 RVA: 0x00004A5B File Offset: 0x00002C5B
		...
		{
			// Token: 0x06000085 RID: 133 RVA: 0x0000521F File Offset: 0x0000341F
			public static float GetRandomPauseDuration()
			{
				return 1f + (float)SamMath.Rand.NextDouble() * 1f;
			}

			// Token: 0x06000086 RID: 134 RVA: 0x00005238 File Offset: 0x00003438
			...
			// Token: 0x06000087 RID: 135 RVA: 0x0000526A File Offset: 0x0000346A
		...
		{
			// Token: 0x06000089 RID: 137 RVA: 0x00005291 File Offset: 0x00003491
		...
		private class MovableForm : Form
		{
			...
			// Token: 0x0600008B RID: 139 RVA: 0x000052F4 File Offset: 0x000034F4
			...
			// Token: 0x0600008C RID: 140 RVA: 0x00005344 File Offset: 0x00003544
		...
		{
			// Token: 0x0600008D RID: 141 RVA: 0x000053A8 File Offset: 0x000035A8
		...
		{
			// Token: 0x0600008F RID: 143 RVA: 0x000054E4 File Offset: 0x000036E4
			...
			// Token: 0x06000090 RID: 144 RVA: 0x000055F4 File Offset: 0x000037F4
		...
		{
			// Token: 0x06000092 RID: 146 RVA: 0x00005658 File Offset: 0x00003858
			...
			// Token: 0x06000093 RID: 147 RVA: 0x000057F8 File Offset: 0x000039F8
			...
			// Token: 0x06000094 RID: 148 RVA: 0x000058D1 File Offset: 0x00003AD1
			private void OpenPatreonLink(object sender, EventArgs a)
			{
				Process.Start("https://www.patreon.com/bePatron?u=3541875");
			}

			// Token: 0x06000095 RID: 149 RVA: 0x000058DE File Offset: 0x00003ADE
			...
			// Token: 0x06000096 RID: 150 RVA: 0x000058EB File Offset: 0x00003AEB
			private void OpenTwitterLink(object sender, EventArgs a)
			{
				Process.Start("https://www.twitter.com/samnchiet");
			}

			// Token: 0x06000097 RID: 151 RVA: 0x000058F8 File Offset: 0x00003AF8
		...
		{
			// Token: 0x06000099 RID: 153 RVA: 0x00005916 File Offset: 0x00003B16
